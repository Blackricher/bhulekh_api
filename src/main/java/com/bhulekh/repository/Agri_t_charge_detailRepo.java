...
import com.bhulekh.entity.Agri_t_charge_detail;
import com.bhulekh.models.Agri_t_charge_detailMode;

import jakarta.transaction.Transactional;

public interface Agri_t_charge_detailRepo extends JpaRepository<Agri_t_charge_detail, Integer> {

	
	@Query(value = " select b.bank_name, c.ifsc_code, to_char(c.dsc_date, 'DD-MM-YYYY') as dsc_date, "
			+ "c.morgage_amount, c.request_id, STRING_AGG(trim(o.name)||'('||trim(o.father)||')', ', ') as pname "
			+ "from agri_t_charge_detail c "
			...
			+ "group by b.bank_name, c.ifsc_code, c.dsc_date, c.morgage_amount, c.request_id ", nativeQuery = true)
	List<Agri_t_charge_detailMode> getCharge(@Param("villageCodeCensus") String villageCodeCensus,
