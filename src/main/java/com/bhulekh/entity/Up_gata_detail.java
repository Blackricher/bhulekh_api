...
@Entity
@Table(name = "up_gata_detail")
public class Up_gata_detail {
	...
	public Up_gata_detail(int seq_no, String district_code_census, String tehsil_code_census, String pargana_code_new,
			String village_code_census, String village_code, String kval, String part, String khata_number,
			String old_khata_number, String khasra_no, float area, String yr_co_ten, String m_admn_flag,
			String created_by, String last_modified_by, long unique_code, String c1, String c2, String c3, String c4,
			String device_serialno, LocalDateTime last_modified_on, LocalDateTime conversionDate,
